...
def try_add_wandb(script_args):
    if script in ["TrainSSL2.py", "EvalFinetune.py", "TrainNorMAE.py"]:
...
def get_experiment_name(*, script, script_args):
    ...
    if script in ["TrainSSL2.py", "TrainNorMAE.py"] and "save_iter" in script_args and int(script_args.save_iter) > 0:

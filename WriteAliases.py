...
aliases = [
    ...
    "alias sqb=\"python ~/.ScriptsAndAliases/Sqb2.py -u \"",        # Concise summary
    "alias sqba=\"python ~/.ScriptsAndAliases/Sqb2.py -u -a \"",    # Includes next-chunk jobs
    "alias sqbau=\"python ~/.ScriptsAndAliases/Sqb2.py \"",         # All jobs, including next-chunk jobs and those of other users

...
cluster2node2config = dict(
    ...
    narval=dict(default=dict(cpus_per_gpu=12, mem_per_gpu=124, gpu_alias="a100", gpus_per_node=4, can_allocate=True, gpu_name="a100"),
        a100=dict(cpus_per_gpu=12, mem_per_gpu=124, gpu_alias="a100", gpus_per_node=4, can_allocate=True, gpu_name="a100"),
        a101=dict(cpus_per_gpu=6, mem_per_gpu=60, gpu_alias="a101", gpus_per_node=7, can_allocate=True, gpu_name="a100_1g.5gb"),
        a112=dict(cpus_per_gpu=6, mem_per_gpu=60, gpu_alias="a112", gpus_per_node=4, can_allocate=True, gpu_name="a100_2g.10gb"),
        a123=dict(cpus_per_gpu=6, mem_per_gpu=60, gpu_alias="a123", gpus_per_node=2, can_allocate=True, gpu_name="a100_3g.20gb"),
        a124=dict(cpus_per_gpu=6, mem_per_gpu=60, gpu_alias="a124", gpus_per_node=1, can_allocate=True, gpu_name="a100_4g.20gb")),
